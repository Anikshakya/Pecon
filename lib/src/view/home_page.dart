                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Anik Shakya", style: poppinsBold(size: 14.sp, color: black),overflow: TextOverflow.ellipsis, maxLines: 2,),
                          SizedBox(height: 2.h),
                          Text("Membership ID: Tranz-202502-4821", style: poppinsSemiBold(size: 9.sp, color: black.withOpacity(0.7)), maxLines: 2,),
                        ],
                      ),
                      const Spacer(),
                      // Total Gained Points
