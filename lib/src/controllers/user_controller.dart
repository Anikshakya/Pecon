...
class UserController extends GetxController {
  ...
  int userPoints = read("user") != "" ? read("user")["earned_points"] : 0;
  ...
  String userName = read("user") != "" ? read("user")["name"] : "N/A";
  String userId =  read("user") != "" ? read("user")["id"] ?? "N/A" : "N/A";
  String userNumber = read("user") != "" ? read("user")["number"] : 0;
